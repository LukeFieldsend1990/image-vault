...
export const CONCEPTS: ConceptEntry[] = [
  ...
  },
  {
    ...
    codePaths: ["lib/monitor/", "lib/monitor/feedback.ts", "app/api/monitor/", "app/(vault)/vault/monitor/", "lib/mcp/tools/likeness-monitor.ts", "lib/mcp/tools/detection-feedback.ts"],
